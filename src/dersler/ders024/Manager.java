...
public class Manager {
	...
	public void ogrenciListesiOlustur() {
		...
		File file = new File(System.getProperty("user.dir") + "\\src\\dersler\\ders024\\ogrenci.txt");
	...
	public void ogrencilerSerilize() {
		File file = new File(System.getProperty("user.dir") + "\\src\\dersler\\ders024\\ogrenciSerilize.txt");
