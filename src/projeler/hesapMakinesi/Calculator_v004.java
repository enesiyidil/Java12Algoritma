 ...
 * Calculator
 * 
 * Added checking for incorrect mathematical expression
 * Added descriptions of functions
 * Console outputs colored
 * Added stringCharCounter function
 * Added the ability to perform operations with nested parentheses for example 10*(20+(30-(40/4)*3)/2)*7+3-45
 * 
 * @author enesb
 * @version v004
 */
public class Calculator_v004 {
	...
	public static void main(String[] args) {
		...
		double result = 0;
		boolean isContainAlphanet = false;
		String mathOperation = "";
		
		while(!isContainAlphanet) {
