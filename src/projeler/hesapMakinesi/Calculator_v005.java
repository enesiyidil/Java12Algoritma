 ...
 * Calculator
 * 
 * Improve checking the suitability of the mathematical expression entered by the user for the system
 * 
 * Added isCorrectExpression and expectedOperator functions
 * 
 * @author enesb
 * @version v005
 */
public class Calculator_v005 {
